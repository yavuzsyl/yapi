...
namespace YAPI.Data.Migrations
{
    ...
    [Migration("20200414222244_PostTag")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YAPI.Domain.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("YAPI.Domain.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("YAPI.Domain.Tag", b =>
                {
                    b.Property<string>("Name")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("YAPI.Domain.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("YAPI.Domain.Tag", b =>
                {
                    b.HasOne("YAPI.Domain.AppUser", "CreatedBy")
                        .WithMany()
